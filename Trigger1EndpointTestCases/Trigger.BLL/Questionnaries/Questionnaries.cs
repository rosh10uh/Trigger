...
namespace Trigger.BLL.Questionnaries
{
    public class Questionnaries
    {
        ...
        /// </summary>
        /// <returns></returns>
        public virtual async Task<CustomJsonData> GetAllQuestionnaries()
        {
            try
            {
                ...
                DataTable questionnariesDataTable = ConvertToDataTable.ToDataTable(questionAnswars);
        ...
        /// <returns></returns>
        private List<QuestionnariesCategory> GetAllQuestWithAnswers(DataTable questions)
        {
            try
            {
