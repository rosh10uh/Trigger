...
namespace Trigger.BLL.Widget
{
    public class Widget
    {
        ...
        public virtual async Task<CustomJsonData> GetUserwiseWidgetAsync(int widgetType, int userId)
        {
            try
            {
        ...
        public virtual async Task<JsonData> AddWidgetPositionAsync(List<WidgetLibrary> widgetLibrary)
        {
            try
            {
