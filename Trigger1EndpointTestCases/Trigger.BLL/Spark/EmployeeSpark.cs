...
namespace Trigger.BLL.Spark
{
    ...
    public class EmployeeSpark
    {
        ...
        /// </summary>
        /// <returns></returns>
        public virtual async Task<CustomJsonData> GetAsync(int empId)
        {
            try
            {
        ...
        /// </summary>
        /// <returns></returns>
        public virtual async Task<CustomJsonData> GetUnApprovedSparkAsync()
        {
            try
            {
        ...
        /// <returns></returns>
        public virtual async Task<CustomJsonData> PostAsync(EmployeeSparkModel employeeSparkModel)
        {
            try
            {
        ...
        /// <param name="employeeSparkModel"></param>
        /// <returns></returns>
        public virtual async Task<CustomJsonData> UpdateSparkApprovalStatus(EmployeeSparkModel employeeSparkModel)
        {
            try
            {
                int empId = Convert.ToInt32(_iClaims["EmpId"].Value);
        ...
        /// <param name="employeeSparkModel"></param>
        /// <returns></returns>
        public virtual async Task<CustomJsonData> PutAsync(EmployeeSparkModel employeeSparkModel)
        {
            try
            {
        ...
        /// <returns></returns>
        public virtual async Task<CustomJsonData> DeleteAsync(int empId, int sparkId, int userId)
        {
            try
            {
        ...
        /// <param name="sparkId"></param>
        /// <returns></returns>
        public virtual async Task<CustomJsonData> DeleteAttachmentAsync(EmployeeSparkModel employeeSparkModel)
        {
            try
            {
                if (_permission.CheckActionPermission(_permission.GetPermissionParameters(Actions.SparkEmployee, PermissionType.CanDelete)))
