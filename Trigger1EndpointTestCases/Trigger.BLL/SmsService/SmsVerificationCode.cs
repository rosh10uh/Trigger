...
namespace Trigger.BLL.SmsService
{
    ...
    public class SmsVerificationCode
    {
        ...
        /// <returns></returns>
        public virtual async Task<JsonData> SendSMSVerificationCode(DTO.SmsService.SmsVerificationCode smsVerificationCode)
        {
            try
            {
        ...
        /// <param name="smsVerificationCode"></param>
        /// <returns></returns>
        public virtual async Task<JsonData> VerifySmsVerificationCode(DTO.SmsService.SmsVerificationCode smsVerificationCode)
        {
            try
            {
