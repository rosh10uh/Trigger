...
namespace Trigger.BLL.DimensionMatrix
{
    ...
    public class DimensionElements
    {
        ...
        /// </summary>
        /// <returns></returns>
        public virtual async Task<CustomJsonData> GetDimensionElements()
        {
            try
            {
        ...
        /// <returns></returns>
        public virtual async Task<JsonData> AddDimensionElements(DimensionElementsModel dimensionElementsModel)
        {
            try
            {
        ...
        /// <param name="dimensionElementsModel"></param>
        /// <returns></returns>
        public virtual async Task<JsonData> UpdateDimensionElements(DimensionElementsModel dimensionElementsModel)
        {
            try
            {
        ...
        /// <param name="dimensionElementsModel"></param>
        /// <returns></returns>
        public virtual async Task<JsonData> DeleteDimensionElements(int dimensionId, int dimensionValueId,int userId)
        {
            try
            {
