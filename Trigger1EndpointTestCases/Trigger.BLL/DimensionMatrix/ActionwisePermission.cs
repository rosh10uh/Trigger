...
namespace Trigger.BLL.DimensionMatrix
{
    ...
    public class ActionwisePermission
    {
        ...
        /// </summary>
        /// <returns></returns>
        public virtual async Task<CustomJsonData> GetActionwisePermission()
        {
            try
            {
        ...
        /// <returns></returns>
        public virtual async Task<JsonData> AddActionwisePermission(List<ActionwisePermissionModel> actionwisePermissionModel)
        {
            try
            {
        ...
        /// </summary>
        /// <returns></returns>
        public virtual async Task<CustomJsonData> GetAllActionsAsync()
        {
            try
            {
        ...
        /// <param name="actionwisePermissionModel"></param>
        /// <returns></returns>
        public virtual async Task<CustomJsonData> CheckWithExistingActionPermission(int empId, List<ActionList> actionwisePermissionModel)
        {
            try
            {
        ...
        /// <param name="actionwisePermissionModel"></param>
        /// <returns></returns>
        public virtual async Task<CustomJsonData> CheckWithExistingActionPermissionV2(int empId, List<ActionList> actionwisePermissionModel)
        {
            try
            {
