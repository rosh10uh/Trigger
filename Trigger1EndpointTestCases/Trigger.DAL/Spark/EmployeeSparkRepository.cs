...
namespace Trigger.DAL.Spark
{
    ...
    public class EmployeeSparkRepository : DaoRepository<EmployeeSparkModel>
    {
        ...
        public virtual EmployeeSparkModel GetEmployeeSparkDetailsBySparkId(EmployeeSparkModel employeeSparkModel)
        {
        ...
        public virtual List<EmployeeSparkModel> GetEmployeeSparkDetails(EmployeeSparkModel employeeSparkModel)
        {
        ...
        public virtual List<EmployeeSparkModel> GetUnApprovedSparkDetails(EmployeeSparkModel employeeSparkModel)
        {
        ...
        public virtual int GetUnApprovedSparkCount(EmployeeSparkModel employeeSparkModel)
        {
            return ExecuteQuery<int>(employeeSparkModel, invokeGetUnApprovedSparkCountByManager);
        }

        //Add new spark details for employee
        public virtual EmployeeSparkModel InsertEmployeeSparkDetails(EmployeeSparkModel employeeSparkModel)
        {
            return ExecuteQuery<EmployeeSparkModel>(employeeSparkModel, invokeAddEmployeeSparkDetails);
        }

        //Update spark approval status
        public virtual EmployeeSparkModel UpdateSparkApprovalStatus(EmployeeSparkModel employeeSparkModel)
        {
        ...
        public virtual EmployeeSparkModel UpdateEmployeeSparkDetails(EmployeeSparkModel employeeSparkModel)
        {
        ...
        public virtual EmployeeSparkModel DeleteEmployeeSparkDetails(EmployeeSparkModel employeeSparkModel)
        {
        ...
        public virtual EmployeeSparkModel DeleteEmployeeSparkAttachment(EmployeeSparkModel employeeSparkModel)
        {
        ...
        public virtual List<AspnetUserDetails> GetAspnetUserByPhoneNumber(EmployeeSparkModel employeeSparkModel)
        {
        ...
        public virtual EmployeeModel GetEmployeeDetailsByEmployeeId(EmployeeSparkModel employeeSparkModel)
        {
        ...
        public virtual List<EmployeeModel> GetTriggerAdminList(EmployeeSparkModel employeeSparkModel)
        {
        ...
        public virtual List<EmployeeModel> GetCompanyAdminList(EmployeeSparkModel employeeSparkModel)
        {
        ...
        public virtual SparkRejectionDetails GetSparkRejectionDetails(EmployeeSparkModel employeeSparkModel)
        {
