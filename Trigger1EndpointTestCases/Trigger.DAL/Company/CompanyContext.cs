...
namespace Trigger.DAL.Company
{
    ...
    public class CompanyContext
    {
        ...
        public CompanyContext(TriggerCatalogContext catalogDbContext, IEnvironmentVariables environmentVariables,
            ILogger<CompanyContext> iLogger, TriggerResourceReader triggerResourceReader,
            EmployeeContext employeeContext, IOptions<AppSettings> appSettings)
        {
        ...
        {
            return string.Format(CompanyResource.DynamicConnectionString, _appSettings.DBServerName, dbName, _appSettings.DBUserName, _appSettings.DBPassword);
        }
        ...
        public int CreateDatabase(CompanyConfigModel companyConfig, string connString, string filePath)
        {
            ...
            try
            {
                ...
                AlterDb(string.Format(Messages.alterDBForCompany, companyConfig.dbName, _appSettings.ElasticPool));
        ...
        private void CreateDb(string dbName)
        {
            ...
            {
                ConnectionString = _appSettings.DefaultConnection.ConnectionString
            };
        ...
        private void ExecuteDbExtTablesObjects(string connString, string fileName, string dbName)
        {
            ...
            try
            {
                ...
                script = script.Replace(Messages.dBPassword, _appSettings.DBPassword)
                    .Replace(Messages.dBUserName, _appSettings.DBUserName)
                    .Replace(Messages.dBServerName, _appSettings.DBServerName)
                    .Replace(Messages.indexDB, _appSettings.IndexDB)
        ...
        {
            SqlConnection sqlConnection = new SqlConnection();
            sqlConnection.ConnectionString = _appSettings.DefaultConnection.ConnectionString;
