...
namespace Trigger.DAL.Spark
{
    public class EmployeeSparkContext
    {
        ...
        /// <returns></returns>
        public async Task<EmployeeSparkModel> AddEmployeeSpark(EmployeeSparkModel employeeSparkModel)
        {
            try
            {
        ...
        /// <param name="employeeSparkModel"></param>
        /// <returns></returns>
        public async Task<int> DeleteAsync(EmployeeSparkModel employeeSparkModel)
        {
            try
            {
        ...
        /// <param name="employeeSparkModel"></param>
        /// <returns></returns>
        public async Task<EmployeeSparkModel> DeleteAttachmentAsync(EmployeeSparkModel employeeSparkModel, bool deleteFromDatabase = true)
        {
            int result = 0;
            try
            {
