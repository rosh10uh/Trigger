...
namespace Trigger.DAL.DashBoard
{
    ...
    public class EmployeeDashboardRepository : DaoRepository<EmployeeDashboardModel>
	{
        ...
        /// <returns></returns>
        public string GetTenantNameByCompanyId(EmployeeDashboardModel employeeDashboardModel)
		{
			return ExecuteQuery<string>(employeeDashboardModel, GetTenantName);
		}
        public List<EmployeeDashboardModel> GetEmployeeDashboard(EmployeeDashboardModel employeeDashboardModel)
        {
