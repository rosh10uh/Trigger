...
namespace Trigger.DAL.Department
{
    ...
    {
        public List<CompanyWiseDepartmentModel> GetCompanyAndYearwiseDepartment(DepartmentModel departmentModel)
        {
            return ExecuteQuery<List<CompanyWiseDepartmentModel>>(departmentModel, Messages.invokeGetCompanyAndYearWiseDepartments);
        }

        public List<CompanyWiseDepartmentModel> GetCompanywiseDepartment(DepartmentModel departmentModel)
        {
