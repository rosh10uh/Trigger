...
namespace Trigger.BLL.Shared
{
    ...
    public static class Messages
    {
        ...
        public const string invokeGetCSVDataWithCount = "GetCSVDataWithCount";
        public const string invokeDeleteTempEmployee = "DeleteTempEmployee";
        public const string invokeGetAllMastersForCSV = "GetAllMastersForCSV";
        public const string invokeAddEmpolyeeFromCSV = "AddEmpolyeeFromCSV";
        public const string invokeGetCSVNewEmployees = "GetCSVNewEmployees";
        public const string invokeAddUserLoginFromCSV = "AddUserLoginFromCSV";
        public const string invokeAddAuthLoginFromCSV = "AddAuthLoginFromCSV";
        public const string invokeGetExistingAuthUsers = "GetExistingAuthUsers";
        public const string invokeAddAuthClaimsFromCSV = "AddAuthClaimsFromCSV";
