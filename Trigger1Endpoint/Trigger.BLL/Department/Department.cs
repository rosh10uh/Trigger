...
namespace Trigger.BLL.Department
{
    public class Department
    {
        ...
        public async Task<CustomJsonData> GetAllDepartmentAsync()
        {
            try
            {
        ...
        /// <returns></returns>
        public async Task<JsonData> AddDepartmentAsync(DepartmentModel departmentModel)
        {
            try
            {
        ...
        /// <param name="departmentModel"></param>
        /// <returns></returns>
        public async Task<JsonData> UpdateDepartmentAsync(DepartmentModel departmentModel)
        {
            try
            {
        ...
        /// <param name="departmentModel"></param>
        /// <returns></returns>
        public async Task<JsonData> DeleteDepartmentAsync(int companyId, int departmentId, string updatedBy)
        {
            try
            {
