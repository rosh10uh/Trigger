...
namespace Trigger.BLL.ChangePassword
{
    public class ChangePassword
    {
        ...
        public JsonData InvokeChangePassword(UserChangePassword userChangePassword)
        {
            try
            {
                AuthUserDetails autData = new AuthUserDetails { UserName = _iClaims["email"].Value };
                AuthUserDetails authPasswordHash = _catalogDbContext.AuthUserDetailsRepository.invokeGetPasswordHashByUserId(autData);
        ...
        public async Task<bool> InvokeRemoveGrantsAsync(string subId)
        {
