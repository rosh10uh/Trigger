...
namespace Trigger.BLL.DimensionMatrix
{
    ...
    public class Dimension
    {
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<CustomJsonData> GetAllDimension()
        {
            try
            {
        ...
        /// <returns></returns>
        public async Task<JsonData> AddDimension(DimensionModel dimensionModel)
        {
            try
            {
        ...
        /// <param name="dimensionModel"></param>
        /// <returns></returns>
        public async Task<JsonData> UpdateDimension(DimensionModel dimensionModel)
        {
            try
            {
