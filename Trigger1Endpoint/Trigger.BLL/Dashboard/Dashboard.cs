...
namespace Trigger.BLL.Dashboard
{
    public class Dashboard
    {
        ...
        /// <returns></returns>
        public async Task<CustomJsonData> GetEmployeeDashBoardAsyncV2(int employeeId)
        {
            try
            {
                bool canView = false;
        ...
        /// <param name="employeeId"></param>
        /// <returns></returns>
        public async Task<CustomJsonData> GetEmployeeDashBoardAsyncV2_1(int employeeId)
        {
            try
            {
        ...
        public async Task<CustomJsonData> GetEmployeeDashBoardAsyncV1(int employeeId)
        {
            try
            {
                var employeeDashboardModel = new EmployeeDashboardModel { empId = employeeId };
        ...
        private List<Remarks> GetRemarks(DataTable empDashboardDetails, int empId)
        {
            return (from DataRow comments in GetCommentsList(empDashboardDetails).Rows
                    ...
                    select new Remarks()
                    {
                        ...
                        assessmentByImgPath = (Convert.ToString(comments["AssessmentByImgPath"]) == "" ? Convert.ToString(comments["AssessmentByImgPath"]) : _storageAccountURL + "/" + _blobContainerEmployee + "/" + Convert.ToString(comments["AssessmentByImgPath"])),
                        DocumentName = (Convert.ToString(comments["DocumentPath"]) == "" ? Convert.ToString(comments["DocumentPath"]) : _storageAccountURL + "/" + Messages.AssessmentDocPath + "/" + Convert.ToString(comments["DocumentPath"]))
                    }).ToList();
        }
